...
- (void)setTeleLab:(NSString *)teleLab{
    ...
    tele = [UILabel createLabelWithFrame:CGRectMake(170, 53, 140, 12) backgroundColor:CLEAN_COLOR textColor:Color_font_dark font:SYSTEM_FONT_(12) textalignment:NSTextAlignmentLeft text:teleLab];
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _lab2 = [UILabel createLabelWithFrame:CGRectMake(ScreenWidth - 30, 40, 30, 12) backgroundColor:CLEAN_COLOR textColor:Color_font_light font:SYSTEM_FONT_(12) textalignment:NSTextAlignmentLeft text:@"取消"];
